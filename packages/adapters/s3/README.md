...
> The official s3 module for RealtimeJS.
...
`@realtimejs/adapter-s3` provides robust, type-safe infrastructure used by the RealtimeJS engine. 
...
```bash
npm install @realtimejs/adapter-s3
```
