...
> The official postgres module for RealtimeJS.
...
`@realtimejs/adapter-postgres` provides robust, type-safe infrastructure used by the RealtimeJS engine. 
...
```bash
npm install @realtimejs/adapter-postgres
```
