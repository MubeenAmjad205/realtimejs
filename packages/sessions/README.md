...
> The official sessions module for RealtimeJS.
...
`@realtimejs/sessions` provides robust, type-safe infrastructure used by the RealtimeJS engine. 
...
```bash
npm install @realtimejs/sessions
```
