...
> The official presence module for RealtimeJS.
...
`@realtimejs/presence` provides robust, type-safe infrastructure used by the RealtimeJS engine. 
...
```bash
npm install @realtimejs/presence
```
